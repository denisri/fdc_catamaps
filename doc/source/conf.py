...
version = '.'.join([str(info.version_major),
                    str(info.version_minor)])
# The full version, including alpha/beta/rc tags.
release = '.'.join([str(info.version_major),
                    str(info.version_minor),
                    str(info.version_micro)])
...
latex_documents = [
  ('index', 'catamap.tex', u'CataMap Documentation',
   u'someone', 'manual'),
]
